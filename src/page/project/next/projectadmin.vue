    ...
    <div>
        <div class="breadcrumb">
            <Breadcrumb>
                ...
                <Breadcrumb-item>项目编辑</Breadcrumb-item>
            </Breadcrumb>
        </div>
        <div id="mc-content">
                    ...
                    <div class="input-item clear active">
                        <div class="form-group new-project-picture">
                            ...
                            <div>
                                ...
                                <span href="javascript:" class="btn btn-type-blue select-picture" id="btn-select-ptcture-substitution" @click="toggleShow">上传图片</span>
